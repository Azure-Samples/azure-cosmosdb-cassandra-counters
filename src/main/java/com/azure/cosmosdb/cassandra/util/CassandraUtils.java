...
public class CassandraUtils {
    ...
    private String cassandraHost = "testcassandra.cassandra.cosmos.azure.com";
    private int cassandraPort = 10350;
    private String cassandraUsername = "testcassandra";
    private String cassandraPassword = "u610EGsuGoemGQYW28YjV2h9Dq6UnuGCYg21wKIxeZV9EpbKLMwyCYjl1hmoh2NIFKNQnUJeG9xHodWmQSuUGQ==";
